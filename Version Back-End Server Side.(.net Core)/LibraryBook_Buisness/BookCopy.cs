...
namespace LibraryBook_Buisness
{
    public class BookCopy
    {
        ...
        private BookCopy(int BookCopyID, int BookID, int LanguageID, bool AvailabilityStatus)
        {
        ...
        public static BookCopy Find(int BookCopyID)
        {
            ...
            {
                return new BookCopy(BookCopyID, BookID, LanguageID, AvailabilityStatus);
